...
class ChannelStatistics:
    ...
    def _generate_file_name(self) -> Path:
        ...
        filename = Path(
            f"Nt_{self.Nt}_K_{self.K}_Nr_{self.Nr}"
...
if __name__ == "__main__":
    ...
    settings = [
        {'Nt': 4, 'K': 2, 'Nr': 2, 'num_channel_realizations': 100_000, 'channel_model': IIDRayleighChannelModel, 'precoding_technique': "ZFPrecoder", 'combining_technique': "NeutralCombiner"},
        {'Nt': 4, 'K': 2, 'Nr': 2, 'num_channel_realizations': 100_000, 'channel_model': IIDRayleighChannelModel, 'precoding_technique': "ZFPrecoder", 'combining_technique': "LSVCombiner"},
        {'Nt': 6, 'K': 2, 'Nr': 2, 'num_channel_realizations': 100_000, 'channel_model': IIDRayleighChannelModel, 'precoding_technique': "ZFPrecoder", 'combining_technique': "NeutralCombiner"},
        {'Nt': 6, 'K': 2, 'Nr': 2, 'num_channel_realizations': 100_000, 'channel_model': IIDRayleighChannelModel, 'precoding_technique': "ZFPrecoder", 'combining_technique': "LSVCombiner"},
        {'Nt': 8, 'K': 2, 'Nr': 2, 'num_channel_realizations': 100_000, 'channel_model': IIDRayleighChannelModel, 'precoding_technique': "ZFPrecoder", 'combining_technique': "NeutralCombiner"},
        {'Nt': 8, 'K': 2, 'Nr': 2, 'num_channel_realizations': 100_000, 'channel_model': IIDRayleighChannelModel, 'precoding_technique': "ZFPrecoder", 'combining_technique': "LSVCombiner"},
